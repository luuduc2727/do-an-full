import TEMPLATE_ONE_IMG from '../assets/image1.jpeg'
import TEMPLATE_TWO_IMG from '../assets/image2.jpg'
import TEMPLATE_THREE_IMG from '../assets/image3.jpg'
...
export const themeColorPalette = {
    themeOne: [
        ...
        ["#F5F4FF", "#EODBFF", "#C9C2F8", "#8579D1", "#4B4B5C"],
        ["#F0FAFF", "#D6F0FF", "#AFDEFF", "#3399FF", "#445361"],
        ["#FFF5F7", "#FFEEC", "#FAC6D4", "#F6729C", "#5A5A5A"],
...
export const DUMMY_RESUME_DATA = {
    ...
    skills: [
    ...
    ], projects: [
        {
            ...
            description: "A task and team management app built with MERN stack. Includes user roles",
            github: "https://github.com/timetoprogram/project-manager-app",
        },
        {
            title: "E-Commerce Platform",
            description: "An e-commerce site built with Next.js and Stripe integration.",
    ...
    interests:
        ["Reading", "Open Source Contribution", "Hiking"],
};
