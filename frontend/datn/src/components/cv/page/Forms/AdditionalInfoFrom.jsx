...
const AdditionalInfoFrom = ({ languages, interests, updateArrayItem, addArrayItem, removeArrayItem }) => {
    return (
        <div className="px-5 pt-5">
            ...
            <div className="flex flex-col gap-4">
                ...
                <button
                    type="button"
                    className="self-start flex items-center gap-2 px-4 py-2 rounded _bg-purple-100 text-purple-800 text-sm font-medium hover:bg-purple-200 cursor-pointer"
